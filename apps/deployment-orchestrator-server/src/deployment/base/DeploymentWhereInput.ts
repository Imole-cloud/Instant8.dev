...
import { PromptHandlerListRelationFilter } from "../../promptHandler/base/PromptHandlerListRelationFilter";
...
class DeploymentWhereInput {
  ...
  @ApiProperty({
    required: false,
    type: () => PromptHandlerListRelationFilter,
  })
  @ValidateNested()
  @Type(() => PromptHandlerListRelationFilter)
  @IsOptional()
  @Field(() => PromptHandlerListRelationFilter, {
    nullable: true,
  })
